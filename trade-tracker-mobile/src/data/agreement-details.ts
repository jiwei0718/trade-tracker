...
export const AGREEMENT_DETAILS: Record<string, AgreementDetail> = {
  ...
  'singapore-australia-dea': {
    latestStatus: {
      ...
      detail:
        '《新加坡—澳洲數位經濟協定》（Singapore-Australia Digital Economy Agreement, SADEA）於 2020 年 8 月 6 日簽署、2020 年 12 月 8 日生效，是星澳 FTA（SAFTA）的升級協定。\n\n【背景】(1) SAFTA 於 2003 年簽署、2003 年 7 月生效，但其電子商務章節（第 14 章）已過時；(2) 雙方均為 DEPA 創始/受邀方，希望在 DEPA 之外建立更高標準的雙邊 DEA；(3) 2019–2020 年 COVID-19 推動數位貿易需求激增，加速 SADEA 完成。\n\n【內容】共 17 條，涵蓋：(1) 數位產品非歧視性待遇；(2) 電子發票；(3) 電子簽章與信任服務；(4) 跨境資料流動（含金融資料）；(5) 算力設施位置；(6) 個人資訊保護；(7) 線上消費者保護；(8) 垃圾訊息；(9) **人工智慧**（首部具拘束力的 AI 條款，雙方承諾合作開發 AI 治理框架）；(10) **金融科技**（互設沙盒、創新合作）；(11) 資料創新（資料共享、開放政府資料）；(12) 監理沙盒；(13) 數位身分（首部具拘束力的數位身分互通條款）。\n\n【影響】(1) SADEA 為「下一代 DEA」之範本，影響 UKSDEA（2022）、KSDPA（2023）、英澳 FTA 數位章節（2023）、ASEAN DEFA（2025）等；(2) 雙方於 2024 年啟動「次世代數位夥伴關係」對話，探討量子計算、AI 治理新領域。',
      asOf: '2025-12', byTool: true,
    },
    indigo: {
  ...
  'uk-singapore-dea': {
    latestStatus: {
      ...
      detail:
        '《英國—新加坡數位經濟協定》（UK-Singapore Digital Economy Agreement, UKSDEA）於 2022 年 2 月 25 日簽署、2022 年 6 月 14 日生效，是英國脫歐後簽署的第一個專門數位經濟協定。\n\n【背景】(1) 英方於 2020 年 12 月脫歐後，啟動「全球英國」（Global Britain）數位貿易戰略；(2) 新加坡為英方亞洲第一大數位貿易夥伴；(3) UKSDEA 借鑒 SADEA（2020）並進一步強化。\n\n【主要內容】共 18 條，涵蓋：(1) 數位貿易便捷化（無紙化貿易、電子簽章、電子發票）；(2) 跨境資料流動（含「金融資料流動議定書」附件）；(3) 算力設施位置禁止；(4) 個人資訊保護；(5) 線上消費者保護；(6) 可信任數位身分系統；(7) AI 治理合作；(8) 金融科技與監理科技（RegTech）；(9) 法律科技（LawTech）；(10) 開放政府資料；(11) 創新與監理沙盒；(12) 中小企業；(13) 數位包容；(14) 加密技術；(15) 原始碼保護。\n\n【特色亮點】(1) **金融資料流動議定書**：是全球首部 FTA 級別具拘束力的金融資料跨境條款；(2) **DLT/區塊鏈合作**：明確納入分散式帳本技術合作；(3) **法律科技**：首部 FTA 級 LawTech 條款。\n\n【後續】英方據此進一步與澳、紐、CPTPP、UAE 等接續安排類似條款。新加坡則繼續以 SADEA、UKSDEA、KSDPA 等堆疊式建構「全球數位協定網絡」。',
      asOf: '2025-12', byTool: true,
    },
    indigo: {
  ...
  'korea-singapore-dpa': {
    latestStatus: {
      ...
      detail:
        '《韓國—新加坡數位夥伴協定》（Korea-Singapore Digital Partnership Agreement, KSDPA）於 2022 年 11 月 21 日簽署、2023 年 1 月 14 日生效，是韓國第一個專門數位經濟協定，亦是韓星《自由貿易協定》（KSFTA，2006 生效）第 14 章電子商務章節的全面升級。\n\n【背景】(1) KSFTA 第 14 章已過時（僅 8 條，未涵蓋資料流動、AI 等新興議題）；(2) 韓方於 2022 年宣布「數位通商戰略」，KSDPA 為其首個試金石；(3) 新加坡延續其「逐個 DEA」全球策略（SADEA→UKSDEA→KSDPA）。\n\n【主要內容】共 24 條 + 9 個附件，涵蓋：\n(1) 數位貿易便捷化（電子發票、無紙化貿易、單一窗口、海關電子合作）；\n(2) 跨境資料流動（含「金融資料流動議定書」附件）；\n(3) 算力設施位置禁止；\n(4) 個人資訊保護（含 CBPR、APEC PRP 機制）；\n(5) 原始碼與演算法保護；\n(6) AI 治理合作（KAIST-NUS 合作、AI 倫理框架）；\n(7) 金融科技合作（含 RegTech、SupTech）；\n(8) 數位身分系統互通；\n(9) 開放政府資料；\n(10) 中小企業數位化；\n(11) 資料創新（資料共享、開放資料、研究合作）；\n(12) 競爭與監理沙盒。\n\n【特色】KSDPA 是「第二代 DEA」更全面之代表，含 AI、金融科技、數位身分模組之深度條款；亦明確納入「韓國通商戰略」與「新加坡智慧國家」之雙邊對接。\n\n【後續】韓方於 2023–2025 年陸續與印尼、印度、新加坡（已成）、加拿大、阿聯啟動 DEA 談判，KSDPA 為其範本。',
      asOf: '2025-12', byTool: true,
    },
    indigo: {
  ...
  'eu-china-cai': {
    latestStatus: {
      ...
      detail:
        '《歐盟—中國全面投資協定》（EU-China Comprehensive Agreement on Investment, CAI）談判自 2014 年 1 月啟動，歷經 35 輪實質會談，2020 年 12 月 30 日於 von der Leyen、Michel、Merkel、Macron 與習近平視訊高峰會中宣布完成原則性談判。\n\n【主要內容】(1) **市場進入**：中方對歐盟企業開放製造業、新能源汽車、雲端服務、金融服務（含證券、保險、銀行）、私募基金、健康照護等；(2) **國民待遇與非歧視**：禁止「強制技轉」、放寬合資要求、提高國有企業透明度；(3) **永續發展**：中方承諾持續努力批准 ILO 強迫勞動公約（第 29 號、第 105 號）；(4) **公平競爭**：政府補貼透明化、SOE 商業中立性。\n\n【未含**投資保護章節**】CAI 主要處理「市場進入」而非「投資保護」（ISDS、ICS 等），歐方計畫於 CAI 生效後 2 年內另立投資保護章節談判。此設計使中方規避 ICS 機制爭議。\n\n【凍結與爭議】\n  - 2021/3：歐盟、英、美、加聯合制裁中方涉新疆 4 名官員與 1 個實體（人權侵害）；\n  - 2021/3：中方對等制裁歐方 10 名 MEP（歐洲議會議員，包括負責 CAI 審議者）、4 個歐方學術機構；\n  - 2021/5/20：歐洲議會以 599-30 大幅多數通過決議，凍結 CAI 批准程序「直至中方解除對 MEP 的制裁」；\n  - 中方拒絕解除制裁，迄今僵局；\n  - 2024/5 von der Leyen 再任歐盟執委會主席，明確表態不重啟 CAI。\n\n【意義】CAI 是冷戰結束以來歐中經貿合作最具雄心、卻最戲劇性失敗的協定，反映 2021 年起全球地緣政治轉折對經貿協定的衝擊。',
      asOf: '2025-12', byTool: true,
    },
    sourceDocs: [
  ...
  'eu-india-fta': {
    latestStatus: {
      ...
      detail:
        '歐印 FTA 談判歷經兩階段：\n\n【第一階段（2007–2013）】2007 年 6 月啟動，歷經 12 輪會談，2013 年 8 月因雙方在汽車、葡萄酒、智財權保護、勞動條款分歧過大而停滯，2015 年正式中止。\n\n【第二階段（2022 起）】2022 年 6 月 17 日 von der Leyen 與 Modi 共同宣布重啟談判，同時談判：\n(1) 自由貿易協定（FTA）；\n(2) 投資保護協定；\n(3) 地理標示（GI）協定。\n\n【進度】至 2025 年底已完成 14 輪實質會談，雙方設定 2025 年底前完成的政治目標，但因分歧明顯，目標延至 2026。\n\n【主要分歧】\n(1) **關稅**：印方對汽車（特別是高級電動車）關稅 60–125%，歐方要求大幅降稅；印方擔憂衝擊國產汽車業；\n(2) **酒類**：印方葡萄酒、烈酒關稅 150%，歐方威士忌、葡萄酒業者強烈要求降稅；\n(3) **農產品**：歐方乳製品、葡萄酒；印方稻米、糖；\n(4) **資料保護**：歐方要求印方達 GDPR 「充分性認定」（adequacy）水準；印方 2023 年通過《數位個資保護法》（DPDP）但執法不足；\n(5) **永續發展**：歐方要求承諾遵守《巴黎協定》、ILO 公約、EUDR；印方視為「保護主義工具」；\n(6) **投資保護**：印方 2017 年單方終止與多國 BIT，要求採印方新模板（嚴格的 ISDS 限制）；歐方主張採 ICS。\n\n【意義】(1) 將是歐盟與單一國家簽署的最大規模 FTA（涵蓋 18 億人口）；(2) 對印度開啟歐洲市場關鍵；(3) 兼具地緣政治意義（歐方「印太戰略」與印方「西方多元化」）。',
      asOf: '2025-12', byTool: true,
    },
    sourceDocs: [
  ...
  'eec-rome': {
    latestStatus: {
      ...
      detail:
        '《羅馬條約》（Treaty of Rome）正式名稱為《建立歐洲經濟共同體條約》（Treaty Establishing the European Economic Community），於 1957 年 3 月 25 日由比利時、法國、義大利、盧森堡、荷蘭、西德 6 國於羅馬卡比托利歐山簽署，1958 年 1 月 1 日生效。同日另簽署《建立歐洲原子能共同體條約》（Euratom Treaty）。\n\n【歷史背景】(1) 1951 年《巴黎條約》成立歐洲煤鋼共同體（ECSC），由 Schuman 計畫主導；(2) 1954 年「歐洲防務共同體」（EDC）談判破裂後，西歐尋求經濟整合作為替代；(3) 1955 年義大利墨西納會議啟動「共同市場」與「原子能共同體」談判，由比利時外長 Spaak 主持的「Spaak 委員會」起草藍圖；(4) 1957 年羅馬條約簽署，奠定 EEC 與 Euratom 兩大基石。\n\n【主要內容】\n(1) **共同市場**：12 年內逐步消除成員間關稅與量化限制（1968 年完成）；建立共同對外關稅；\n(2) **四大自由**：貨品、人員、服務、資本自由流動（首度於國際條約中明文制度化）；\n(3) **共同政策**：農業（CAP）、運輸、競爭、外貿；\n(4) **機構**：歐洲議會（諮詢角色）、理事會（部長級決策）、執委會（提案與監督）、法院（司法）、經社委員會；\n(5) **共同外貿**：以「共同對外關稅」進行對外貿易談判（會員國放棄個別主權）；\n(6) **海外國家領地**：保留法、比、荷殖民地之優惠關係。\n\n【演進】\n  - 1968：關稅同盟提前完成\n  - 1973：英、丹、愛爾蘭加入（第一次擴大）\n  - 1981、1986：希臘、西、葡加入\n  - 1986：《單一歐洲法》（SEA）強化單一市場\n  - 1992：馬斯垂克條約創立歐盟（EU），EEC 改稱「歐洲共同體」（EC）\n  - 2009：里斯本條約完全廢除「歐洲共同體」名稱，整合為歐盟單一法律實體\n\n【歷史意義】(1) 羅馬條約之原則（特別是四大自由）至今仍是歐盟運作核心；(2) 為戰後歐洲長達 70+ 年和平與經濟繁榮的制度基礎；(3) 為全球區域整合（包括 ASEAN、Mercosur、AfCFTA）提供範本；(4) 條約形式經多次修訂後，今稱為《歐盟運作條約》（TFEU）。',
  ...
  'asean-founding': {
    latestStatus: {
      ...
      detail:
        '《東南亞國家協會宣言》（ASEAN Declaration，俗稱《曼谷宣言》）於 1967 年 8 月 8 日由 5 個東南亞國家外長簽署：印尼（Adam Malik）、馬來西亞（Tun Abdul Razak）、菲律賓（Narciso Ramos）、新加坡（S. Rajaratnam）、泰國（Thanat Khoman），於泰國曼谷外交部宣布成立東南亞國家協會（ASEAN）。\n\n【冷戰背景】(1) 1967 年正值越戰高峰、印中關係惡化、馬印對峙（Konfrontasi）甫結束；(2) 5 國均對共產主義（特別是中共支持的東南亞共產黨叛亂）有共同威脅感；(3) 美國對亞洲承諾不確定，5 國希望透過區域團結提升談判實力；(4) 印尼新政府 Suharto 上任，扭轉前任 Sukarno 反西方政策，使區域合作得以實現。\n\n【ASEAN 創立宣言 7 大目標】(1) 加速經濟成長、社會進步、文化發展；(2) 區域和平穩定；(3) 共同努力於經濟、社會、文化、技術、科學、行政等領域合作；(4) 互相援助於訓練與研究；(5) 農業、工業、貿易、運輸、通訊更密切合作；(6) 促進東南亞研究；(7) 與既有國際與區域組織維持密切互利合作。\n\n【非干涉原則 ASEAN Way】(1) 不干涉內政（non-interference）；(2) 共識決（consensus）；(3) 漸進主義（gradualism）；(4) 非正式對話（informal dialogue）。此「東協方式」（ASEAN Way）使其能容納政治制度迥異的成員（君主、議會民主、共產、軍政府），但也常被批評為「最小公分母」、議題處理緩慢。\n\n【擴員時序】創始 5 國 → 汶萊（1984）→ 越南（1995）→ 寮、緬（1997）→ 柬埔寨（1999）→ 達成 ASEAN-10。東帝汶於 2022 年獲觀察員地位，預計未來成為第 11 個會員。\n\n【重要里程碑】1971 ZOPFAN 宣言、1976 TAC 友好合作條約、1992 AFTA 啟動、2003 同心圓三共同體（APSC、AEC、ASCC）規畫、2007 ASEAN 憲章、2015 三共同體建立、2020 RCEP 簽署、2023 DEFA 啟動、2025 共同體願景 2045。\n\n【全球地位】2024 年總人口 6.8 億、合計 GDP 4 兆美元（全球第 5 大經濟體）、平均年齡 30 歲（年輕人口紅利）、年均成長率 5%；對外貿易 3 兆美元；2020 起為中國最大貿易夥伴、日本第二大；外資流入連年成長。',
      asOf: '2025-12', byTool: true,
    },
  ...
  'cer-anzcerta': {
    latestStatus: {
      ...
      detail:
        '《澳洲—紐西蘭更緊密經濟關係貿易協定》（Australia-New Zealand Closer Economic Relations Trade Agreement, ANZCERTA，俗稱 CER）於 1983 年 3 月 28 日簽署、1983 年 1 月 1 日追溯生效（簽署日為協定正式化日，雙方早於 1983 年 1 月即實質適用）。前身為 1965 年《澳紐自由貿易協定》（NAFTA，與北美 NAFTA 無關）。\n\n【主要特色】CER 是全球公認自由化程度最高、最全面的 FTA 之一：\n(1) **貨品**：1990 年雙邊貿易達成全面零關稅，並消除所有量化限制；\n(2) **服務**：1988 年《服務貿易議定書》使服務業近乎完全自由化；\n(3) **反傾銷**：1990 年起雙方間不再適用反傾銷與平衡稅（改以競爭法處理）；\n(4) **法規調和**：1992 年起推動「單一經濟市場」（SEM）議程，逐步調和食品安全、藥品、商業法、稅務、競爭法、移民等；\n(5) **業務移動**：1973 年《跨塔斯曼旅行安排》（Trans-Tasman Travel Arrangement）使雙方公民可自由進出、居住、工作；\n(6) **政府採購**：1991 年《政府採購安排》整合至中央政府層級；\n(7) **司法**：相互承認判決、商業仲裁。\n\n【深度整合】(1) **單一通貨曾被討論**：1990 年代曾辯論「澳元化」（兩國使用單一貨幣），最終未實現但留下廣泛貨幣協調；(2) **企業跨境合併**：經 1992 年商業法調和後，雙方企業合併視同國內案件；(3) **產品標準**：1996《跨塔斯曼貨品標準相互承認安排》（TTMRA）使一方核准之產品自動為另一方承認。\n\n【經濟成果】1983 年雙邊貿易 30 億澳元，2024 年達 280 億澳元（9 倍成長）；澳方為紐方第一大貿易夥伴、紐方為澳方第八大；服務業整合特別深入（雙方銀行業、保險業、零售業互相主導）。\n\n【意義】(1) CER 為全球 FTA 模範生，被引為 EU 以外最深度整合的雙邊體系；(2) 為 ASEAN-Australia-NZ FTA、CPTPP 提供範本；(3) 體現「同源文化 + 地緣鄰近 + 政治意願」之 FTA 成功公式。',
      asOf: '2025-12', byTool: true,
    },
